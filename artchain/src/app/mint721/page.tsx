  ...
  return (
    <main>
      <section className="flex justify-center relative bg-custom pb-24">
        <div className="grow max-w-xs mr-4 mt-5 rounded-2xl bg-white dark:text-neutral-100 dark:bg-neutral-700 dark:border-neutral-400 border ease-linear duration-200 relative p-2">
      ...
      <section className="align justify-center py-10 px-6 bg-green-400 dark:bg-green-800 flex">
        <div className="flex px-10 flex-col md:w-full w-1/2 rounded items-center py-4 bg-white dark:bg-neutral-700 dark:border-neutral-400 relative bottom-20 border">
          ...
          <input
            ...
            id="name"
            value={nft.name}
            className="outline-none dark:text-black dark:bg-slate-100 dark:border-neutral-400 border rounded pl-2 py-2 w-full mt-4"
          />
          <input
            onChange={onInputChange}
            type="text"
          ...
          <input
            ...
            className="outline-none  dark:text-neutral-200 dark:border-neutral-400 border rounded pl-2 py-2 w-full mt-4"
            type="file"
            id="file"
          />
          <button
            onClick={mint}
            className="px-6 py-3 rounded ease-linear dark:bg-indigo-700 dark:hover:bg-indigo-800 duration-100  bg-indigo-400 hover:bg-indigo-500 text-white w-2/3 mt-4"
          >
            MINT NOW
          </button>
